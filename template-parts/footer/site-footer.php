...
// Định dạng lại số điện thoại sang kiểu 0911.469.969
$formatted_phone  = preg_match( '/^(\d{4})(\d{3})(\d{3})$/', $phone ) ? preg_replace( '/(\d{4})(\d{3})(\d{3})/', '$1.$2.$3', $phone ) : $phone;
$formatted_phone2 = preg_match( '/^(\d{4})(\d{3})(\d{3})$/', $phone2 ) ? preg_replace( '/(\d{4})(\d{3})(\d{3})/', '$1.$2.$3', $phone2 ) : $phone2;
?>
        ...
        <div class="container-site site-footer-main__grid">
            ...
            <div class="site-footer-main__column">
                ...
                <p class="site-footer-main__line site-footer-main__line--address">
                    <a href="https://maps.google.com/?q=<?php echo urlencode($factory); ?>" target="_blank" rel="noopener">
                        <strong><?php esc_html_e( 'Địa chỉ nhà máy: ', 'goldenbee' ); ?></strong><?php echo esc_html( $factory ); ?>
                    </a>
                </p>
                <p class="site-footer-main__line site-footer-main__line--address">
                    <a href="https://maps.google.com/?q=<?php echo urlencode($office); ?>" target="_blank" rel="noopener">
                ...
                <p class="site-footer-main__line site-footer-main__line--phone">
                    <strong><?php esc_html_e( 'Hotline: ', 'goldenbee' ); ?></strong><?php echo esc_html( $formatted_phone . ' - ' . $formatted_phone2 ); ?>
                </p>
                <p class="site-footer-main__line site-footer-main__line--email">
                    <strong><?php esc_html_e( 'Email: ', 'goldenbee' ); ?></strong><a href="mailto:<?php echo esc_attr( $email ); ?>"><?php echo esc_html( $email ); ?></a>
                </p>
            </div>
