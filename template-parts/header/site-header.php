    ...
    <div class="bg-[#003680] w-full relative">
        <div class="max-w-[1200px] mx-auto px-4 flex items-center justify-between box-border">
            ...
            <div class="flex items-center flex-1 min-w-0">
                <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="px-5 py-4 text-[15px] font-bold text-white bg-[#5CB815] hover:bg-green-600 uppercase no-underline inline-block tracking-wide shrink-0">
                ...
                <ul id="primary-nav" class="m-0 p-0 list-none flex items-center flex-1 justify-start">
                    ...
                    <li class="relative group dropdown-nav-item">
                        <a href="<?php echo esc_url( $shop_url ); ?>" class="px-[13px] py-4 flex items-center gap-1 text-[15px] font-bold text-white uppercase no-underline group-hover:bg-blue-500 transition-colors whitespace-nowrap">
